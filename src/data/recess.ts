...
const ECONOMY_BLOCKS: SekiraBlock[] = [
  {
    type: 'card',
    card: {
      title: `23.9 · ועדת הכספים — אישור 11.758 מיליארד ש"ח להוצאות הביטחון`,
      brief: 'ועדת הכספים תתכנס ביום רביעי כדי לאשר 11.758 מיליארד ש"ח עבור הוצאות הביטחון של צה"ל ומשרד הביטחון.',
      paras: [
        {
          text: `ברקע המאבק על הגדלת תקציב הביטחון: ועדת הכספים תתכנס ביום רביעי הבא כדי לאשר 11.758 מיליארד ש"ח עבור הוצאות הביטחון של צה"ל ומשרד הביטחון.`,
        },
      ],
      expandables: [
        {
          summary: 'הרחבה',
          paras: [
            { text: `לפי הדיווחים, הוועדה מתכנסת ביום רביעי 23.9, מיד לאחר יום כיפור, כדי לאשר העברות בהיקף כולל של 14.748 מיליארד ש"ח למערכת הביטחון - כספים שאושרו בממשלה ותקועים בכנסת מאז 2.8. מתוך הסכום, כ-11.5 מיליארד ש"ח כבר הוגשו בעבר לאישור הכנסת.` },
            { text: `הפנייה שבמרכז הדיון היא בקשה 2026/15-216, "הקצאת רזרבות מלחמה": העברת 11.758 מיליארד ש"ח מסעיף 47, הרזרבה הכללית, לסעיף 15, משרד הביטחון, לתוכנית 151101 "הוצאות ביטחוניות". בנוסח הפנייה נכתב שפירוט השימושים יימסר בוועדה המשותפת לוועדת הכספים ולוועדת החוץ והביטחון.` },
            { text: `הכספים מיועדים למימון עלויות הפעילות הביטחונית ולמימון שירות המילואים.` },
            { text: `באותה ישיבה יידונו העברות נוספות: 72 מיליון ש"ח למשרד לביטחון לאומי, 46 מיליון ש"ח למשרד ירושלים ומסורת ו-6 מיליון ש"ח לתקציב הרווחה.` },
            { text: `טרם הושגה הסכמה על התוספת הנוספת שדורש צה"ל, בהיקף של יותר מ-25 מיליארד ש"ח, על רקע מחלוקת בין ראש הממשלה נתניהו ליו"ר האופוזיציה לפיד בנוגע למקורות המימון.` },
            {
              muted: true,
              head: 'סימוכין',
              text: '',
              links: [
                ...
                { label: 'ביזפורטל, 4.9.26', url: 'https://www.bizportal.co.il/guides/news/article/20041292' },
              ],
            },
          ],
        },

...
על החלטה לפסול רשימה ניתן לערער לבית המשפט העליון. פסילת מועמד טעונה אישור של בית המשפט העליון.`,
  ...
  },
  {
    ...
    category: `כלכלה`,
    importance: `ודאי`,
    detail: `ועדת הכספים מתכנסת ביום רביעי 23.9, מיד לאחר יום כיפור, כדי לאשר 11.758 מיליארד ש"ח עבור הוצאות הביטחון של צה"ל ומשרד הביטחון - פנייה 2026/15-216, "הקצאת רזרבות מלחמה", מסעיף 47 לסעיף 15. הפנייה היא חלק מחבילה בהיקף 14.748 מיליארד ש"ח שתקועה בכנסת מאז 2.8. טרם הושגה הסכמה על התוספת הנוספת שדורש צה"ל, בהיקף של יותר מ-25 מיליארד ש"ח.`,
    url: `https://www.ynet.co.il/economy/article/hywaynktze`,
  },
  {
